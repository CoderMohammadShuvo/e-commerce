  ...
  return (
    <div className="min-h-screen ">
      <main className="">
        ...
        <ProductSet1 />
        <NewArrival />
        <footer className="w-full bg-[#246400] text-white py-8 px-4 sm:px-6 lg:px-12">
      {/* Newsletter Section */}
      <div className="max-w-lg mx-auto text-center flex flex-col gap-4">
        <p className="text-lg sm:text-2xl font-medium">Subscribe to our Newsletter</p>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 sm:gap-10 lg:gap-12 w-full max-w-5xl mx-auto mt-8">
        ...
        <div>
          ...
          <p className="text-sm mt-2">Fashion That Defines You and Boosts Confidence</p>
        </div>
      </div>
